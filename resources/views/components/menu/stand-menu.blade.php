            ...
            <nav id="sidebar">
                ...
                <div class="navbar-nav theme-brand flex-row  text-center">
                    <div class="nav-logo">
                        ...
                        <div class="nav-item theme-text">
                            @if (auth()->check())
                            <a href="{{getRouterValue();}}/aluno/my" class="nav-link"> {{App\Models\Role::find(Auth::user()->role)->name}} </a>
                            @else
                            <a href="{{getRouterValue();}}/aluno/my" class="nav-link"> Visitante </a>
                            @endif
                        </div>
                    </div>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu {{ Request::is('*/app/eco/*') ? "active" : "" }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ Request::is('*/app/eco/*') ? "show" : "" }}" id="eco" data-bs-parent="#accordionExample">
                    ...
                    <li class="menu {{ Request::is('*/campaign/*') ? "active" : "" }}">
                        ...
                        <ul class="collapse submenu list-unstyled {{ Request::is('*/campaign/*') ? "show" : "" }}" id="campaign" data-bs-parent="#accordionExample">
                            ...
                            <li class="{{ Request::routeIs('campaign-list-campaigns') ? 'active' : '' }}">
                                <a href="{{getRouterValue();}}/app/campaign/add_course"> Código </a>
                            </li>
