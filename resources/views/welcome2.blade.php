            ...
            <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
                <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    <a href="#" class="flex items-center">
                        <img src="./logo.svg" class="h-6 mr-3 sm:h-9" alt="Profissionaliza EAD" />

                        <span
                            class="self-center text-xl font-semibold whitespace-nowrap text-gray-700 dark:text-white">Profissionaliza
                            EAD</span>
                    </a>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div
                ...
                <div class="mr-auto place-self-center lg:col-span-7">
                    <div class="sd:block lg:hidden lg:mt-0 lg:col-span-5 max-w-32">
                        <img src="https://demo.themesberg.com/landwind/images/hero.png" alt="hero image" style="max-width: 300px;">
                    </div>
                    
                    <h1
                        class="max-w-2xl mb-4 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl text-gray-500 dark:text-white text-center">
                        Moderno e intuitivo.</h1>
                    <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
                        Os melhores Cursos e Preparações do mercado para você se preparar para o futuro.</p>
            ...
            <div class="max-w-screen-xl px-4 pb-8 mx-auto lg:pb-16">
                <div
                    ...
                    <a href="#" class="flex items-center lg:justify-center">
                        <img src="adobe_- logo-100x25.svg" alt="">
                    </a>
                    <a href="#" class="flex items-center lg:justify-center">
                        <img src="google_- logo-1000x327.svg" alt="">
                    </a>
                    <a href="#" class="flex items-center lg:justify-center">
                        <img src="microsoft_- logo-1000x214.svg" alt="">
                    </a>
                    <a href="#" class="flex items-center lg:justify-center">
                        <img src="oracle_- logo-100x13.svg" alt="">
                    </a>
                    <a href="#" class="flex items-center lg:justify-center">
                        <img src="aprendiz-legal.svg" alt="">
                    </a>
            ...
            <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
                ...
                <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                    <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                        <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Como
                            funciona?</h2>
                        <p class="mb-8 font-light lg:text-xl">Nosso sistema de aulas é focado no aprendizado acelerado,
                            onde os conteúdos são objetivos e as atividades tem foco em fixação.</p>
                        <!-- List -->
                        <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                            <li class="flex space-x-3">
                                ...
                                <span
                                    class="text-base font-medium leading-tight text-gray-900 dark:text-white">Plataforma
                            ...
                            <li class="flex space-x-3">
                                ...
                                <span
                                    class="text-base font-medium leading-tight text-gray-900 dark:text-white">Disponibilidade
                                    24hs</span>
                            </li>
                            <li class="flex space-x-3">
                                <!-- Icon -->
                                ...
                                <span
                                    class="text-base font-medium leading-tight text-gray-900 dark:text-white">Professores
                                    especialistas</span>
                            </li>
                        </ul>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div
                ...
                <div class="col-span-2 mb-8">
                    <p class="text-lg font-medium text-purple-600 dark:text-purple-500">Diversas opções para você</p>
                    <h2
                        class="mt-3 mb-4 text-3xl font-extrabold tracking-tight text-gray-900 md:text-3xl dark:text-white">
                        Nós temos mais de 100 opções de Cursos a sua escolha.</h2>
                    <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">Opções como cursos interativos
                        onde você decide o tempo que quer dedicar aos seus estudos, até cursos com aulas ao vivo onde
                        você tem interação em tempo real com o Professor.</p>
                ...
                <div class="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                    <div>
                        ...
                        <h3 class="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Cursos de Tecnologia</h3>
                        <p class="font-light text-gray-500 dark:text-gray-400">Tudo que você quiser aprender de mais
                    ...
                    <div>
                        ...
                        <h3 class="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Cursos Profissionalizantes
                        </h3>
                        <p class="font-light text-gray-500 dark:text-gray-400">Você escolhe a profissão e nós preparamos
                            o conteúdo.</p>
                    </div>
                    <div>
                        <svg class="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500"
                        ...
                        <h3 class="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Preparatórios para Concursos
                        </h3>
                        <p class="font-light text-gray-500 dark:text-gray-400">Professores especialistas em concursos
                            dedicam horas para que você seja aprovado.</p>
                    </div>
                    <div>
                        <svg class="w-10 h-10 mb-2 text-purple-600 md:w-12 md:h-12 dark:text-purple-500"
                            fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 class="mb-2 text-2xl font-bold text-gray-900 dark:text-white">Inglês para o Mundo</h3>
                        <p class="font-light text-gray-500 dark:text-gray-400">Aprenda inglês de forma rápida, intuitiva
                            e com exercícios dinâmicos.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="bg-gray-50 dark:bg-gray-800">
            <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-24 lg:px-6">
                <figure class="max-w-screen-md mx-auto">
                    ...
                    <blockquote>
                        <p class="text-xl font-medium text-gray-900 md:text-2xl dark:text-white">"O modelo de ensino da
                            Profissionaliza me ajudou a concluir mais de 10 cursos em um período de tempo bem curto,
                            fiquei muito feliz pois com um bom currículo as portas de um emprego se abriu rapinho para
                            mim."</p>
                    </blockquote>
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
                <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Conheça nossos
                        principais programas de estudo.</h2>
                    <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Programas de estudo são
                        pacotes que possuem a especialidade de uma área específica e as suas capacitações.</p>
                </div>
                <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                    ...
                    <div
                        ...
                        <h3 class="mb-4 text-2xl font-semibold">Jovem Aprendiz</h3>
                        <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400">Ideal para Jovens e
                            Adolescentes que procuram oportunidade de ingressar no mercado de trabalho.</p>
                        ...
                        <ul role="list" class="mb-8 space-y-4 text-left">
                            ...
                            <li class="flex items-center space-x-3">
                                ...
                                <span>Complemento 10 Cursos Profissionalizantes</span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <!-- Icon -->
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
                                ...
                                <span>Opcional Inglês para negócios</span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <!-- Icon -->
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
                    ...
                    <div
                        class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
                        <h3 class="mb-4 text-2xl font-semibold">Pré-Militar</h3>
            ...
            <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
                <div class="max-w-screen-sm mx-auto text-center">
                    <h2 class="mb-4 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">
                        Precisa de Ajuda?</h2>
                    <p class="mb-2 font-light text-gray-500 dark:text-gray-400 md:text-lg">Fale com o nosso Suporte agora.</p>
                    <p class="mb-6 font-light text-gray-500 dark:text-gray-400 text-xs">Suporte 24hs robotizado / Suporte humanizado das 09hs às 18hs Seg/Sex</p>
                    <a href="#"
                        class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800">Fale Conosco </a>
                </div>
            </div>
        </section>
        <!-- End block -->
        <footer class="bg-white dark:bg-gray-800">
            <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="text-center">
                    ...
                    <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2019-2024 Profissionaliza EAD™. Todos os direitos reservados.
                    </span>
                    <span class="block text-sm text-center text-gray-500 dark:text-gray-400">
                        As logotipos apresentadas não expressam vínculos com as empresas, mas sim com programas.
                    </span>
