                        ...
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="text-center user-info">
                                ...
                                <form action="{{ route('user-profile-active', $user->id) }}" method="POST"
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="#desbloquearModal"
                                        class="btn btn-success btn-lg mt-4" data-toggle="tooltip" data-placement="top"
                                        title="Desbloquear"> Desbloquear
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    ...
                                    <li class="contacts-block__item">
                                        <div class="form-group">
                                            <input class="form-check-input me-1" id="ouro" name="ouro" type="checkbox"
                                                @if ($user->ouro == 1 ) checked @endif disabled>
                                            Contratou 10 Cursos
                                        </div>
                                    </li>
                                                ...
                                                <form class="form-horizontal">
                                                    <div class="clipboard-input">
                                                        <input type="text" class="form-control inative" id="copy-basic-input"
                                                            value="{{ $cademi->login_auto }}" readonly>
                    ...
                    <div class="user-profile">
                        <div class="widget-content widget-content-area">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                {{--<a
                                    href="{{getRouterValue();}}/app/user/profile/{{ $user->id }}/courses"
                                    class="mt-2 edit-profile"> <svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a data-bs-toggle="modal" href="" data-bs-target="#OuroModal"
                                        class="mt-2 edit-profile" data-toggle="tooltip"
                                        data-placement="top" title="Adicionar Cursos">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" id="...">
                                        ...
                                        <section class="mb-0 mt-0">
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a data-bs-toggle="modal" data-bs-target="#delOuroModal{{$course['id']}}" class="text-danger" data-toggle="tooltip" data-placement="top" title="Adicionar Cursos">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p class="modal-text">Você tem certeza que deseja prosseguir com exclusão?</p>
                                                <p class="text-danger">Essa ação é destrutiva não pode revertida, todos os registros desse curso serão apagados.</p>
                                            </div>
                                            ...
                                            <form
                                            action="{{getRouterValue();}}/app/user/ouro/delete/{{ $course->id }}"
                                            ...
                                            <div class="list-group">
                                                <div
                                                    ...
                                                    <div class="btn-group dropstart align-self-center" role="group">
                                                        <a id="paymentHistory1" href="javascript:void(0);"
                                                ...
                                                <div
                                                    ...
                                                    <span class="pay-pricing align-self-center me-3">$45</span>
                                                    <div class="btn-group dropstart align-self-center" role="group">
                                                        <a id="paymentHistory2" href="javascript:void(0);"
                                                            class="dropdown-toggle" data-bs-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                ...
                                                <div
                                                    ...
                                                    <span class="pay-pricing align-self-center me-3">$45</span>
                                                    <div class="btn-group dropstart align-self-center" role="group">
                                                        <a id="paymentHistory3" href="javascript:void(0);"
                                                            class="dropdown-toggle" data-bs-toggle="dropdown"
                                                            aria-haspopup="true" aria-expanded="false">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <div class="widget-content widget-content-area">
                                            ...
                                            <div class="list-group">
                                                <div
                                                    ...
                                                    <span
                                                        class="badge badge-success align-self-center me-3">Primary</span>
                                                </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p class="modal-text">Você tem certeza que deseja prosseguir com o bloqueio
                                                do
                                                usuário?<br><br>Para efetuar o desbloqueio siga o procedimento:<br>1º
                                                Ative as compras
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <p class="modal-text">Siga as etapas abaixo antes de prosseguir?<br><br>1º
                                                Ative as compras
                                                do usuário na Cademi <a class="btn btn-secondary  mb-2 me-4 btn-sm"
                                                    target="_blank"
                            ...
                            <div id="vendedorModal" class="modal animated fadeInDown" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form
                                            action="{{getRouterValue();}}/app/user/profile/{{ $user->id }}/seller_create"
                            ...
                            <div id="vendedordModal" class="modal animated fadeInDown" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form
                                            action="{{getRouterValue();}}/app/user/profile/{{ $user->id }}/seller_delete"
