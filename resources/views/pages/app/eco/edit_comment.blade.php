<x-base-layout :scrollspy="false">
    ...
    <div class="row mb-4 layout-spacing layout-top-spacing">
        ...
        <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <form action="{{ getRouterValue(); }}/app/eco/comment/{{$id}}/{{$i}}"  method="post" enctype="multipart/form-data" name="form1" class="was-validated">
                @csrf
            <div class="widget-content widget-content-area blog-create-section mb-4">
                ...
                <div class="row mb-4">
                    <div class="col-xxl-8 col-md-8 mb-3">
                        <label>Nome</label>
                        <input type="text" class="form-control" name="name" id="name" placeholder="Nome" value="{{$comment->name}}" required>
                    </div>
                </div>
                ...
                <div class="row mb-2">
                    ...
                    <button type="send" class="btn btn-success w-100">Salvar</button>
            </form>
        </div>
