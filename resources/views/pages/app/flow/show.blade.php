                            ...
                            <div data-draggable="true" class="card task-text-progress">
                                <div class="card-body">
                                    ...
                                    <div class="task-header">
                                        ...
                                        <div class="">
                                            <h4 class="" data-taskTitle="Launch New SEO Wordpress Theme ">{{$entry->user->name}} {{$entry->user->lastname}}</h4>
                                        </div>
                                    ...
                                    <div class="task-body">
                                        ...
                                        <div class="task-content">
                                            <a data-taskText="{{$entry->user->cellphone}}"><x-widgets._w-svg svg="brand-whatsapp"/>  {{$entry->user->cellphone}} </a>
                                        ...
                                        <div class="task-bottom">
                                            <div class="tb-section-1">
                                                <span data-taskDate="{{$entry->created_at}}"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg> {{$entry->created_at->format('d/m/y h:i')}} </span>
                                            </div>
