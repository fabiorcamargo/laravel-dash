                    ...
                    <div id="OuroComboCreateModal" class="modal animated fadeInDown" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ route('post-cert-create') }}" method="POST" id="combo_create"
                                    class="py-12">
                                    @csrf
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="table-responsive ps" id="table1">
                                    <div class="statbox widget box box-shadow">
                                        ...
                                        {{--$cert->id--}}
                                        <div id="EditCertModal{{$cert->id}}" class="modal animated fadeInDown"
                                            role="dialog">
                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    
                                                    <form action="{{ route('post-cert-edit', ['id' => $cert->id]) }}"
                                                        method="POST" id="cert_edit{{$cert->id}}" class="py-12">
                                                        @csrf
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="col-xxl-12 col-md-12 mb-4">
                                                                ...
                                                                <input type="text" class="form-control" id="name"
                                                                    name="name" value="{{$cert->cert_certificates_model_id}}" required>
                                                            </div>
                                                            <div class="col-xxl-12 col-md-12 mb-4">
                                                                <p for="combo_name">Tipo</p>
                                                                <select class="form-control form-control" id="type"
                                                            ...
                                                            <div class="col-xxl-12 col-md-12 mb-4">
                                                                ...
                                                                <input type="number" class="form-control" id="hours"
                                                                    name="hours" value="{{$cert->percent}}" required>
                                                            </div>
                                                            <div class="col-xxl-12 col-md-12 mb-4">
                                                                <p for="combo_name">Carga horária</p>
                                                                <div class="col-sm-12">
                                                                    <textarea class="form-control" name="conteudo"
                                                                        id="conteudo" rows="5"
                                                                        required>{!! $cert->velidity !!}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <td>
                                                <div class="card style-5 bg-dark mt-4 mb-md-0 mb-4">
                                                    ...
                                                    <div class="card-content">
                                                        <div class="card-body">
                                                            <h5 class="card-title mb-2">{{$cert->getuser()->name}} {{$cert->getuser()->lastname}}
                                                            </h5>
                                                            ...
                                                            <p class="card-text">{!!
                                                                ...
                                                                $cert->content) !!}</p>
                                                            <form
                                                                action="{{route('cert-del-emit', ['id' => $cert->id])}}"
                                                                ...
                                                                <a href="{{route('cert-view', ['code' => $cert->code])}}"
                                                                    target="_blank"
                                                                    type="button"
                                                                    class="badge badge-primary mb-2 bs-tooltip"
                                                                    title="Ver">
