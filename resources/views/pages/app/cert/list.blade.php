                                                        ...
                                                        <div class="modal-body">
                                                            <div class="col-xxl-12 col-md-12 mb-4">
                                                                ...
                                                                <input type="text" class="form-control" id="name"
                                                                    name="name" value="{{$cert->name}}" required>
                                                            </div>
                                                            <div class="col-xxl-12 col-md-12 mb-4">
                                                                <p for="combo_name">Tipo</p>
                                                                <select class="form-control form-control" id="type"
                                                                    name="type" required>
                                                                    <option value="{{$cert->type}}">{{$cert->type}}
                                                                    </option>
                                                                    <option value="cademi">Cademi</option>
                                                                    <option value="cademi">Ouro Moderno</option>
                                                                </select>
                                                            ...
                                                            <div class="col-xxl-12 col-md-12 mb-4">
                                                                ...
                                                                <input type="number" class="form-control" id="hours"
                                                                    name="hours" value="{{$cert->hours}}" required>
                                                            </div>
                                                            <div class="col-xxl-12 col-md-12 mb-4">
                                                                <p for="combo_name">Carga horária</p>
                                                                <div class="col-sm-12">
                                                                    <textarea class="form-control" name="conteudo"
                                                                        id="conteudo" rows="5"
                                                                        required>{!! $cert->content !!}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <td>
                                                <div class="card style-5 bg-dark mt-4 mb-md-0 mb-4">
                                                    ...
                                                    <div class="card-content">
                                                        <div class="card-body">
                                                            <h5 class="card-title mb-2">{{ $cert->id }} | {{ $cert->name }}
                                                            </h5>
                                                            <h6 class="">Carga Horária:{{ $cert->hours }}</h6>
                                                            <p class="card-text">{!!
                                                                str_replace(['\r','\n'], [""," <br> "],
                                                                $cert->content) !!}</p>
                                                            <form
                                                                action="{{route('cert-del', ['id' => $cert->id])}}"
