            ...
            <div class="row layout-top-spacing">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><span
                                                    class="shadow-none badge badge-success">Cartão</span></td>
                                            @elseif ($user["payment"] == "BOLETO")
                                            <td class="text-center"><span
                                                    class="shadow-none badge badge-primary">Boleto</span></td>
                                            @else
                                            <td class="text-center"><span
                ...
                <form action="{{ getRouterValue(); }}/csv" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-end">
                        <p>Total de Usuários da lista: {{ count($users[0]) }} <button type="submit"
                                class="btn btn-primary mb-2 me-4">Enviar</button></p>
                    </div>
                </form>
                            ...
                            <form action="{{ getRouterValue(); }}/store" method="post" enctype="multipart/form-data">
                                ...
                                <div id="fuMultipleFile" class="col-lg-12 layout-spacing">
                                    ...
                                    <div class="col-md-6 mx-auto pt-4 pb-4">
                                        <div class="row">
                                            <div class="col-md-6 mx-auto pt-4 pb-4">
                                                <input class="form-check-input me-1" id="observation" name="observation"
                                                    type="checkbox">
                                                <label for="city">Somente Observações</label>
                                            </div>
                                            <div class="col-md-6 mx-auto pt-4 pb-4">
                                                <input class="form-check-input me-1" id="courses" name="courses"
                                                    type="checkbox">
                                                <label for="courses">Somente Cursos</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row"></div>
                                    <div class="col-md-6 mx-auto">
                                        ...
                                        <div class="row">
                                            <div class="mb-3">
                                                <input id="autoComplete" name="city" name="city" class="form-control"
                                                    required onblur="submeter()">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class=""><span class="shadow-none badge badge-success">Success</span>
                                            </td>
