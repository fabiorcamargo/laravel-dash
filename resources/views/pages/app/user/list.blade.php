                ...
                <div id="tableSimple" class="col-lg-12 col-12 layout-spacing">
                        <div class="widget-header">
                            <div class="row dt--top-section">
                                <div class="col-12 col-lg-8 col-sm-12 d-flex justify-content-sm-start justify-content-center">
                                ...
                                <div class="col-12 col-lg-4 col-sm-12 d-flex justify-content-sm-end justify-content-center mt-sm-0 mt-3">
