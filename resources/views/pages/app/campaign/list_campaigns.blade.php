                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                        <div class="action-btns">
                                            ...
                                            <a href="{{ getRouterValue(); }}/app/campaign/msg/send/pro/{{ $form->id }}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Enviar em Massa ChatPro">
                                                <x-widgets._w-svg svg="message-chatbot"/>
                                            </a>
                                            <a href="{{ getRouterValue(); }}/app/campaign/msg/send/wp/{{ $form->id }}" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Enviar em Massa Api Oficial">
                                                <x-widgets._w-svg svg="brand-whatsapp"/>
                                            </a>
                                        </div>
                                </td>
                            </tr>
